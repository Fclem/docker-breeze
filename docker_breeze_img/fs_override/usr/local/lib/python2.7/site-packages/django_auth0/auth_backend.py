...
class Auth0Backend(object):
	def authenticate(self, **kwargs):
		...
		"""
		"email_verified": true,
		"updated_at": "2016-10-26T10:05:09.334Z",
		"picture": "",
		"name": "clement.fiere@fimm.fi",
		"""

		try:
			user = UserModel.objects.get(username__iexact=user_nick, password__iexact=user_id)
		except UserModel.DoesNotExist:
			user = UserModel.objects.create(username=user_nick, email=user_email, password=user_id)
