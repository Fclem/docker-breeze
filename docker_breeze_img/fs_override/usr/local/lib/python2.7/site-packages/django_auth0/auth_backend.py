...
class Auth0Backend(object):
    def authenticate(self, **kwargs):
        ...
        try:
            user = UserModel.objects.get(username__iexact=username, password__iexact=user_id)
        except UserModel.DoesNotExist:
            user = UserModel.objects.create(username=username, password=user_id, is_active=False)
