...
echo -e ${GREEN}"Enter the path for the project folder on the host ${END_C}"
...
print_and_do "echo \"#### AUTOGENERATED BY init.sh ####\n" \
	"project_folder='${local_root_path}'\">>${local_root_path}/const.sh"
# reloads configs
source ${local_root_path}/run_conf.sh
